...
namespace Client
{
    public partial class Form1 : Form
    {
        ...
        static string pathToDownloads = @"C:\Users\user\Desktop\ЛАБА6\";
        ...
        {
            Person person = new Person("binaryKhlystov", 20);
        ...
        {
            var students = new List<Student>() { new Student("Khlystov", "IB196"), new Student("Maxim/Nikolay", "1") };
            ns = new NetworkStream(clientSocket);
        ...
        {
            var persons = new List<Person>() { new Person("Khlystov", 20), new Person("Maxim/Nikolay", 25) };
            ns = new NetworkStream(clientSocket);
                ...
                case 0:
                    {
                        ...
                        MessageBox.Show($"File - {fileName} is done!");
                        bWrite.Close();
                        break;
                    }
                case 1:
                ...
                case 2:
                    {
                        ...
                        ns.Close();
                        MessageBox.Show($"File - file.json is done!");
                        break;
                    }
                case 3:
                    {
                        ...
                        ns.Close();
                        MessageBox.Show($"File - file.xml is done!");
                        break;
                    }
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (ClientPort_.Text != string.Empty)
            {
                ...
                MessageBox.Show("Заполните необходимые поля!", "Warning!", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
            ...
            if (ServerPort_.Text != string.Empty)
            {
                ...
                startThreadListener = new Thread(() =>
                {
                    ...
                    while (true)
                    {
                        ...
                        //receiveThread = new Thread(() => { Receive(clientSocket); });
